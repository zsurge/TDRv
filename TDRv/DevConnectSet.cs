        ...
        private void btn_ConnectDev_Click(object sender, EventArgs e)
        {
            ...
            if (combDevType.Text.Contains("E5080B") || combDevType.Text.Contains("PNA"))
            {
                ...
                else if (sn.Contains("MY59202434"))
                {
                    ...
                    if (202307301400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY59203255")) //临时测试使用1个月，2023.07.03
                {
                    ...
                    if (202308031400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY59101203")) //add 2022.05.27 临时增加测试使用
                {
                    ...
                    if (202306301400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY63056301")) //add 2023.04.02
                {
                    ...
                    if (202309031400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
            ...
            else if (combDevType.Text.Contains("E5063A"))
            {
                ...
                {
                    if (202309281400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
