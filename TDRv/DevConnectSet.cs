    ...
    public partial class DevConnectSet : Form
    {
        ...
        private void btn_ConnectDev_Click(object sender, EventArgs e)
        {
            ...
            if (combDevType.Text.Contains("E5080B") || combDevType.Text.Contains("PNA"))
            {
                ...
                else if (sn.Contains("MY59500134")) //add 2024.06.24
                {
                ...
                else if (sn.Contains("MY59400238")) //参展样机，一个月 add 2024.03.14
                {
                    ...
                    if (202407171400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY59202618")) //modify 2024.05.22
                {
                ...
                else if (sn.Contains("MY63056301")) //add 2023.04.02
                {
                    ...
                    if (202408271400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
            ...
            else if (combDevType.Text.Contains("E5063A"))
            {
                ...
                if (sn.Contains("MY54706251")) //add 2024.5.22
                {
                    //已付款
                    if (209903011400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                ...
                if (sn.Contains("MY54706247")) //add 2024.05.22
                {
                    //已付款
                    if (209903011400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                ...
                else if (sn.Contains("MY54706611"))
                {
                    if (202409041400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
            ...
            else if (combDevType.Text.Contains("E5071C"))
            {
                ...
                {
                    if (202408101400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY47002764")) //20240514 modify 2099
                {
                    if (209912301400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                ...
                {
                    if (202407131400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY46901930")) //add 20240701
                {
                    if (202409011400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
