        ...
        private void btn_ConnectDev_Click(object sender, EventArgs e)
        {
            ...
            if (combDevType.Text.Contains("E5080B"))
            {
                ...
                else if (sn.Contains("MY59202434"))
                {
                    ...
                    if (202210281400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY59202302")) //add 2022.05.27 临时增加测试使用
                {
                    ...
                    if (202211021400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY59201793"))
                {
                    ...
                    if (202211151400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
            ...
            else if (combDevType.Text.Contains("E5063A"))
            {
                ...
                {
                    if (202210201400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                {
                    if (202211301400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                {
                    if (202210251400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
            ...
            else if (combDevType.Text.Contains("E5071C"))
            {
                ...
                else if (sn.Contains("MY46630895")) //add 2022.09.26 样机 三个月 12.26
                {
                    if (202212261400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
