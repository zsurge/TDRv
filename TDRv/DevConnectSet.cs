        ...
        private void btn_ConnectDev_Click(object sender, EventArgs e)
        {
            ...
            if (combDevType.Text.Contains("E5080B") || combDevType.Text.Contains("PNA"))
            {
                ...
                else if (sn.Contains("MY63057096")) //add 2023.09.09
                {
                    ...
                    if (202312091400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY59203255")) //临时测试使用1个月，2023.07.03
                {
                    ...
                    if (202310311400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
                ...
                else if (sn.Contains("MY59202618"))
                {
                    ...
                    if (202311191400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
            ...
            else if (combDevType.Text.Contains("E5063A"))
            {
                ...
                {
                    if (202312111400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
            ...
            else if (combDevType.Text.Contains("E5071C"))
            {
                ...
                else if (sn.Contains("MY46733941")) //add 2023.10.24  三个月 
                {
                    if (202406021400 - Convert.ToInt64(DateTime.Now.ToString("yyyyMMddHHmm")) <= 0)
                    {
                        optStatus.isConnect = false;
                        combDevString.BackColor = Color.Red;
                        return;
